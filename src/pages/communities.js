...
//     // Assuming communitiesData is fetched asynchronously and updated with useState
//     const [communitiesData, setCommunitiesData] = useState([]);
...
//                                         <Col className={`mt-2 mt-lg-0 ${isFilterOpen ? 'col-lg-12' : 'col-lg-9'}`}>
//                                             <Row className="g-3 g-md-4 ">
//                                                 {/* Map over communitiesData to render community cards */}
//                                                 {communitiesData.map((community, index) => (
//                                                     <Col lg={4} key={"community" + index}>
//                                                         <div className="community-card">
//                                                             <div className="avatar">
//                                                                 <Image src={community.avatarSrc} alt="Avatar" width={56} height={56} />
//                                                             </div>
...
//                                                                         <span key={"tag" + tagIndex} className={`tag ${tag.color}`}>
//                                                                             {tag.label}
//                                                                         </span>
//                                                                     ))}
//                                                                 </div>
...
//                                                                 <div className="likes">{community.likes} Likes</div>
//                                                                 <div className="total-raise">Total Raise: {community.totalRaise}</div>
//                                                                 <div className="chain-info">
//                                                                     Contribute Chain: {community.contributeChain}
//                                                                 </div>
//                                                                 <div className="chain-info">
//                                                                     Distribute Chain: {community.distributeChain}
//                                                                 </div>
//                                                             </div>
//                                                         </div>
//                                                     </Col>
...
//             <Col lg={4}>
//               <CommunityDetailsListCard  key={community.id} communityData={community} />
//             </Col>
//           ))}
//         </Row>
//       </Container>
