                                        ...
                                        <div className='card-content'>
                                            <div className='d-flex justify-content-between align-items-center '>
                                                <div className='d-flex align-items-center icon-title text-black'>
                                                    ...
                                                    <div>
                                                        <h3 className="fw-bold fs-5 mb-1">@{'liza'}</h3>
                                            ...
                                            <div className='prog-bar mt-3 mb-1 text-start'>
                                                <span className="content-font">{'Current Crowdsale Period'}</span>
                                                <div className='progbar'>
                                                    <div className='progress-container'>
                                                        <div className='progress-bar' style={{ width: '20%' }}></div>
                                                        <div className='shadow-animated' style={{ width: '20%' }}></div>
                                                    </div>
                                                    <span>{'20%'}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div className='points-list'>
                                                ...
                                                <div className='list'>
                                                    <p>Join Network:</p>
                                                    <p className='d-flex align-items-center'><Image src={'/img/BNB.png'} width={24} height={24} alt={'BNB'} className='d-inline-block me-2' /> {'BNB'}</p>
                                                </div>
                                                <div className='list'>
                                                    <p>Distribution Network:</p>
                                                    <p className='d-flex align-items-center'><Image src={'/img/POLYGON.png'} width={24} height={24} alt={'POLYGON'} className='d-inline-block me-2' /> {'POLYGON'}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <button className={`live-btn text-uppercase rounded-bottom`}>
                                    ...
                                    <div className="order-wrapper">
                                        <div className='counter-list second mt-4 mt-lg-0 d-flex flex-wrap'>
                                            <div className='counter-boxnew'>
                                                ...
                                                <h3 className="mb-0">$<CountUp end={1} />M</h3>
                                            </div>
                                            <div className='counter-boxnew'>
                                                <span>Total Distributed</span>
                                                <h3 className="mb-0">$<CountUp end={500} />k</h3>
                                            </div>
                                            <div className='counter-boxnew'>
                                                <span>Total Followers   </span>
                                                <h3 className="mb-0"><CountUp end={10} />k+</h3>
                                            </div>
                                            <div className='counter-boxnew'>
                                                <span>Feedback Score</span>
                                                <h3 className="mb-0">4.5 | 200</h3>
                                            </div>
                                        </div>
                                        <Image src={'/img/card.png'} alt="image" className="img-fluid counter-image w-100 mt-4 mt-lg-4" width={782} height={469} />
                                    </div>
                                </Col>
                            </Row>
                            <Row className="g-3 g-md-4 mt-3 mt-md-3">
                                <Col lg={12}>
                                    <Nav variant="tabs" defaultActiveKey={activeTab} className="tabs-buttons mb-3">
                                        <Nav.Item>
                                            <Nav.Link eventKey="All" onClick={() => handleTabChange('All')}>All</Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item>
                                            <Nav.Link eventKey="Live" onClick={() => handleTabChange('Live')}>Live</Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item>
                                            <Nav.Link eventKey="Upcomming" onClick={() => handleTabChange('Upcomming')}>Upcomming</Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item>
                                            <Nav.Link eventKey="Ended" onClick={() => handleTabChange('Ended')}>Ended</Nav.Link>
                                        </Nav.Item>
                                    </Nav>
                                </Col>
